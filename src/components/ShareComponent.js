...
import '../../static/share.scss';

const Share = ({ socialConfig, tags }) => (
	<div className="post-social">
		<span className="text">Share: </span><FacebookShareButton url={socialConfig.config.url} className="button is-outlined is-rounded facebook" >
			<span className="icon">
